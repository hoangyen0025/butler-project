...
function IconPrint() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M6 2h12v5H6V2zm14 7H4a2 2 0 0 0-2 2v6h4v-2h12v2h4v-6a2 2 0 0 0-2-2zm-2 3.5a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5zM8 15h8v7H8v-7z" />
    </svg>
  );
}
...
function IconDownload() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M11 3a1 1 0 0 1 2 0v9.586l2.293-2.293a1 1 0 1 1 1.414 1.414l-4 4a1 1 0 0 1-1.414 0l-4-4a1 1 0 1 1 1.414-1.414L11 12.586V3zM5 18a1 1 0 0 1 1-1h12a1 1 0 1 1 0 2H6a1 1 0 0 1-1-1z" />
    </svg>
  );
}
